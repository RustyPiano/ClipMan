...
- Internationalization: English and Chinese UI support with auto language detection.
...
- Copy from window/tray now moves the item to the top of the recent list, matching duplicate copy behavior.
...
- 从窗口/托盘复制时，内容会移动到最近列表顶部，与复制重复内容行为一致。
